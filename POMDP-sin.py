...
# -*- coding: utf-8 -*-
"""
UR10e + Barrett hand + panel hinge (IMPROVED + error-cost & error-risk + CSV logging):
--------------------------------------------------------------------------------------
...
New in this version:
• Comprehensive CSV logging at ~10 Hz. The CSV file is named after this
  Python file, with .csv replacing .py (e.g., 'script.py' → 'script.csv').
"""
