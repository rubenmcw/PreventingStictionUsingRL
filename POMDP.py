...
def pomdp_only_ctrl(action_levels: np.ndarray,
    ...
    def inner(k, theta, dtheta, belief, last_u_ref):
        ...
        # Precompute belief‑weighted friction *now* for convenience
        tau_f_now = [friction_torque(theta, dtheta, j, params) for j in range(N_REG)]
...
class HingePOMDP:
    ...
    def __init__(self, model, data, joint_name="hinge_joint",
                 ...
                 J_est=POMDP_J_EST,
                 D_est=POMDP_D_EST,
                 use_learned_transition: bool = False,
